...
int main()
{
	...
	Villano* enemigo = FactorySingleton::getInstance()->crearPersonaje<Villano>();
	Princesa* obejtivo = FactorySingleton::getInstance()->crearPersonaje<Princesa>();
	Principe* usuario = FactorySingleton::getInstance()->crearPersonaje<Principe>();
	cout << endl;
